...
import { playlists, subs as subscriptions } from "../data/sidebar";
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={`w-56 lg:sticky absolute top-0 overflow-y-auto scrollbar-hidden flex-col gap-2 px-2 ${
      ...
      >
        ...
        <LargeSidebarSection title="Explore">
          {/* <LargeSidebarItem IconOrImgUrl={} title="" url=""/> */}
          <LargeSidebarItem
            IconOrImgUrl={Flame}
            title="Trending"
            url="/trending"
          ...
          <LargeSidebarItem IconOrImgUrl={Gamepad2} title="News" url="/news" />
          <LargeSidebarItem
